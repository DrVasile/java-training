package com.javatraining.springboot.exception.handlers;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBookNotFound(Exception exception, WebRequest webRequest) {
        return handleExceptionInternal(exception, "Book not found", new HttpHeaders(), HttpStatus.NOT_FOUND, webRequest);
    }
